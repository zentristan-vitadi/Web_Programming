...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO tbl_zakat (nama_donatur, jenis_zakat, Jumlah_uang, Jumlah_beras, metode, tanggal, keterangan) VALUES('$NamaPanjangVar', '$JenisZakatVar', '$JumlahUangVar', '$JumlahBerasVar', '$MetodeVar', '$TanggalVar', '$KeteranganVar')");
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4 fw-bold">Tambah Data Zakat</h3>
                                </div>
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-group my-3">
                                            <label for="" class="form-control-label mx-1 fw-bold">Nama</label>
                                            <input type="text " class="form-control" name="nama_donatur" placeholder="ajam..." required>
                                        </div>
                                        <div class="form-group my-3">
                                        ...
                                        <div class="form-group my-3">
                                            ...
                                            <input type="number" class="form-control" name="jumlah_beras" placeholder="10" value="0">
                                        </div>
                                        <div class="form-group my-3">
                                        ...
                                        <div class="form-group my-3">
                                            ...
                                            <input type="number" class="form-control" name="keterangan" placeholder="Jumlah Orang Berzakat..." required>
                                        </div>
